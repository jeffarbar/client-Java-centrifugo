...
public class Centrifugo {
    ...
    public void connect() {
        if (client == null || (state != STATE_CONNECTED && state != STATE_CONNECTING)) {
            ...
            if (uri.getScheme().equals("wss")) {
                ...
                try {
                	sslContext = NaiveSSLContext.getInstance("TLSv1.2");
    ...
    public void setJoinLeaveListener(  final JoinLeaveListener joinLeaveListener) {
        this.joinLeaveListener = joinLeaveListener;
    }

    public void setSubscriptionListener(  final SubscriptionListener subscriptionListener) {
    ...
    public void setDataMessageListener(  final DataMessageListener dataMessageListener) {
    ...
    public void logErrorWhen(final String when, final Exception ex) {
       System.out.println( "Error occured  " + when +  ": " + ex);
    }
    ...
    protected void onSubscriptionError(  final String subscriptionError) {
        if (subscriptionListener != null) {
            subscriptionListener.onSubscriptionError(null, subscriptionError); //FIXME: rewrite using channel name
        }
    }

    protected void onSubscribedToChannel(  final String channelName) {
        if (subscriptionListener != null) {
    ...
    public void sendMessage(final String channel , JSONObject data){
    	JSONObject jsonObject = montaMensagem(channel , data);
    	client.send( jsonObject.toString() );
    }
    
    public void sendMessage(final String channel , String json){
    	JSONObject jsonObject = montaMensagem(channel , json);
    	client.send( jsonObject.toString() );
    }
    
    public static JSONObject montaMensagem(final String channel , final String json ) throws JSONException {
    ...
    public static JSONObject montaMensagem(final String channel , final JSONObject data ) throws JSONException {
    ...
    public void subscribe(final SubscriptionRequest subscriptionRequest,  final String lastMessageId) {
     ...
     */
    protected String fillSubscriptionJSON(final JSONObject jsonObject, final SubscriptionRequest subscriptionRequest,  final String lastMessageId) throws JSONException {
     ...
     */
    protected void onMessage(  final JSONObject message) {
    ...
    public void setReconnectConfig(  final ReconnectConfig reconnectConfig) {
...
jefferson
        ...
        public void onError(final Exception ex) {
            ...
            try {
            	...
            	System.out.println( "Error while closing WS connection: " + e.getMessage());
            }
        }
    ...
    public static class Builder {
        ...
        public Builder(  final String wsURI) {
            this.wsURI = wsURI;
        }
        ...
        public Builder setReconnectConfig( final ReconnectConfig reconnectConfig) {
            this.reconnectConfig = reconnectConfig;
            return this;
        }
